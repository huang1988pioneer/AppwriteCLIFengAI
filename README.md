...
<p align="center"><img src="docs/banner.png" alt="貓咪騎自行車" width="624"></p>
...
node scripts/gen-banner.mjs                          # 重新產生「貓咪騎自行車」像素圖（src/banner-art.js）
node scripts/gen-banner.mjs --png docs/banner.png   # 更新 README 圖片；--preview 在終端機預覽
```
